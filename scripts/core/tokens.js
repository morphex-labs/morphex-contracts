...
module.exports = {
  // fantomTestnet: {
  //   btcPriceFeed: { address: "0x65E8d79f3e8e36fE48eC31A2ae935e92F5bBF529" },
  //   ethPriceFeed: { address: "0xB8C458C957a6e6ca7Cc53eD95bEA548c52AFaA24" },
  //   ftmPriceFeed: { address: "0xe04676B9A9A2973BCb0D1478b5E1E9098BBB7f3D" },
  //   daiPriceFeed: { address: "0x9BB8A6dcD83E36726Cc230a97F1AF8a84ae5F128" }, // using usdt price feed
  //   usdcPriceFeed: { address: "0x9BB8A6dcD83E36726Cc230a97F1AF8a84ae5F128" }, // using usdt price feed
  //   usdtPriceFeed: { address: "0x9BB8A6dcD83E36726Cc230a97F1AF8a84ae5F128" },

  //   btc: {
  //     address: "0x960A8DFb58D443f5fffac146E5b9EdE87c2bB90A",
  //     decimals: 18
  //   },
  //   eth: {
  //     address: "0x107919364Fd351874d586C8725bB7B5E9e9cBA7f",
  //     decimals: 18
  //   },
  //   ftm: {
  //     address: "0x3f3760F86aBCE717AE9933F4E164A3049893bE2e",
  //     decimals: 18
  //   },
  //   usdc: {
  //     address: "0x4e2070676A8dC708ba1dcB0496F3699990605b59",
  //     decimals: 18
  //   },
  //   usdt: {
  //     address: "0x60f248A755C4a0c9904A2a76b520abfbA2340B68",
  //     decimals: 18
  //   },
  //   dai: {
  //     address: "0x8C3968606F69DBfA91D47C5425bcd2F7Aa4EfCD0",
  //     decimals: 18
  //   },
  //   nativeToken: {
  //     name: "wftm",
  ...
  //     isStable: false,
  //     isShortable: true,
  //     maxGlobalLongSize: 13 * 1000 * 1000,
  ...
  fantom: {
    ...
    dai: {
      ...
      decimals: 18,
      priceFeed: "0x91d5DEFAFfE2854C7D02F50c80FA1fdc8A721e52",
      priceDecimals: 8,
      isStrictStable: true,
      tokenWeight: 5000,
      minProfitBps: 0,
      maxUsdgAmount: 90 * 1000,
      bufferAmount: 500 * 1000,
      isStable: true,
      isShortable: false
    },
