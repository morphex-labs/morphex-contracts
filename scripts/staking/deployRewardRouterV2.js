...
async function main() {
  ...
  const stakedGmxDistributor = await deployContract("RewardDistributorV2", [gmx.address, stakedGmxTracker.address])
  // const stakedGmxDistributor = await contractAt("RewardDistributor", "0x05D97A8a5eF11010a6A5f89B3D4628ce43092614");
  await sendTxn(stakedGmxTracker.initialize([gmx.address, gmx.address], stakedGmxDistributor.address), "stakedGmxTracker.initialize")
